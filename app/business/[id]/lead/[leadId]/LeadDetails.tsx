  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        {/* Lead Info */}
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">Information</h2>
          <dl className="space-y-3">
            <div className="flex justify-between">
              <dt className="text-gray-600">Phone</dt>
              <dd className="font-medium text-gray-900">{currentLead.phone}</dd>
            </div>
            {currentLead.instagram && (
              <div className="flex justify-between">
                <dt className="text-gray-600">Instagram</dt>
                <dd className="font-medium text-gray-900">@{currentLead.instagram.replace('@', '')}</dd>
              </div>
            )}
        ...
        {/* Status Change */}
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">Change Status</h2>
        ...
        {/* Follow-up Date */}
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          <h2 className="text-sm font-medium text-gray-500 mb-3">Follow-up Date</h2>
          <div className="flex gap-3">
            <input
              type="date"
              value={followupDate}
          ...
          {currentLead.next_followup_at && (
            <p className="mt-2 text-sm text-gray-500">
              Current: {formatDate(currentLead.next_followup_at)}
            </p>
          )}
        </div>
        ...
        <div className="bg-white rounded-xl border border-red-200 p-4">
          <h2 className="text-sm font-medium text-red-600 mb-3">Danger Zone</h2>
          {!showDeleteConfirm ? (
            <button
